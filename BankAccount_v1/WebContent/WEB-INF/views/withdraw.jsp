...
<div align="center" class="jumbotron">
		...
		<h1 class="display-8">Withdraw</h1>
		
		<br>
		
		<div align="center">
		
		<form:form  action="withdrawbalance"  method="post" modelAttribute="editedformbalance">
			...
			<table class="table table-hover table-dark">
				...
				<tr>
					...
					<td><form:input  path="balance" placeholder="Withdraw Amount"/></td>
				</tr>		
