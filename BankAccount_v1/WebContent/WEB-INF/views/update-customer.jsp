...
<div align="center" class="jumbotron">
		...
		<form:form action="updatecustomer" method="post" modelAttribute="editedcustomer" >
			...
			<table class="table table-hover table-dark">
				...
				<tr>
					<td>Phone No:</td>
					<td><form:input path="phoneNo" placeholder="Phone Number"/></td>
				</tr>				
				<tr>
					<td>Account Type:</td>
				...
				<tr>
					<td>Account No:</td>
					<td><form:input path="accountNo" placeholder="Account Number"/></td>
				</tr>							
				<tr>
					<td>Bank Card No:</td>
				...
				<tr>
					<td>Street Number:</td>
					<td><form:input path="address.streetNo" placeholder="Street Number"/></td>
				</tr>		
				<tr>
					<td>Street Name:</td>
					<td><form:input path="address.streetName" placeholder="Street Name"/></td>
				</tr>	
				<tr>
					<td>City:</td>
				...
				<tr>
					...
					<td><form:input path="address.province" placeholder="Province"/></td>
				</tr>	
				<tr>
